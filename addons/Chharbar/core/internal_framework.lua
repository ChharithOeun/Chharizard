-- ============================================================================
-- Chharbar / core / internal_framework.lua  (Chharizard v5.4.0+)
--
-- CHB namespace, widget helpers, prerender tick dispatcher, mouse pipeline,
-- command router, auto-hide gate, per-toon state I/O, perf profiler.
-- Required by Chharbar.lua AFTER core/framework.lua (which handles cross-
-- platform detection and installs the windower.* shim on Ashita).
--
-- On Windower this uses windower.* natively.
-- On Ashita this uses the compat_ashita.lua shim installed by framework.lua.
-- Either way, the same code runs.
-- ============================================================================
