-- ============================================================================
-- Chharsai — Mog Garden + Furrow + Rearing automation for FFXI.
--
-- Ported verbatim from Noirblanc's Bonsai v1.4.1. Original attribution
-- preserved; this file is a light adapter over Noirblanc's state machine.
--
-- Original state machine (STATE_IDLE / STATE_MOVING / STATE_POKED /
-- STATE_SENDING / STATE_INTER_MESSAGE / STATE_COOLDOWN / STATE_PHASE_WAIT)
-- is production-tested and works correctly on Windower and (via the
-- Chharizard core/compat_ashita.lua shim) Ashita v4.
--
-- Commands aliased under //chharsai, //sai, //bon, //bonsai. Any pattern
-- users learned from vanilla Bonsai still works verbatim.
--
-- Original copyright (c) 2024 Noirblanc, all rights reserved.
-- Chharizard adaptation (c) 2026 Chharizard, MIT with attribution.
-- ============================================================================

_addon.name     = 'Chharsai'
_addon.author   = 'Chharizard (adapted from Noirblanc Bonsai v1.4.1)'
_addon.version  = '5.10.0'
_addon.commands = {'chharsai', 'sai', 'bonsai', 'bon'}
...
local function chat(msg) windower.add_to_chat(207, '[Chharsai] ' .. msg) end
local function err(msg)  windower.add_to_chat(123, '[Chharsai] ' .. msg) end
